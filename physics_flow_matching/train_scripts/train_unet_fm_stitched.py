...
from physics_flow_matching.utils.dataloader import get_stitching_loaders
from physics_flow_matching.utils.dataset import DATASETS
from physics_flow_matching.utils.train_stitched import train_model
...
def main(config_path):
    ...
    train_dataloader = get_stitching_loaders(vf_paths=config.dataloader.datapath,
                                             data_size=config.dataloader.data_size,
