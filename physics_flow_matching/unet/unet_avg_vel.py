...
class UNetModel(nn.Module):
    ...
    def forward(self, r, t, x, y=None):
        ...
        :param future_timesteps: a 1-D batch of timesteps.
        ...
        emb = emb + self.future_time_embed(timestep_embedding(future_timesteps, self.model_channels))
...
class UNetModelWrapper(UNetModel):
    ...
    def forward(self, r, t, x, y=None, *args, **kwargs):
        return super().forward(r, t, x, y=y)