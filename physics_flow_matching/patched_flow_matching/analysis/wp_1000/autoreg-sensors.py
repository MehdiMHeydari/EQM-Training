...
np.save(f"/home/meet/FlowMatchingTests/conditional-flow-matching/physics_flow_matching/patched_flow_matching/exps/wp/exp_{exp}/samples_cond_autoreg_{iteration}_s{int(mask.sum())}.npy", samples*std + m)