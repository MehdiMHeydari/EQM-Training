...
# std = np.load("/home/meet/FlowMatchingTests/conditional-flow-matching/physics_flow_matching/patched_flow_matching/exps/wp/std_180_is.npy")
...
mask[..., ::10, ::10] = 1. #[..., ::16, ::16] #[..., ::11, ::11] #[..., ::8, ::8] #[..., ::4, ::4]
mask = mask[..., :-1, :-1]
...
np.save(f"/home/meet/FlowMatchingTests/conditional-flow-matching/physics_flow_matching/patched_flow_matching/exps/wp/exp_{exp}/samples_cond_autoreg_{iteration}_s{int(mask.sum())}.npy", (samples*std*scale + m))