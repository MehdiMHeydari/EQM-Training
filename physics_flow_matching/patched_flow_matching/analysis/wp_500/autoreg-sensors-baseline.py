...
total_samples = 1
samples_per_batch = 1
streamwise_length = 600

mask = np.zeros((1,1,2400, 400))
mask[..., ::7, ::40] = 1.
    ...
    for i in range(2400//window_length):
        if i == 0:
            sample = infer_grad_generalized(fm = FlowMatcher(1e-3), cfm_model=model,
                            ...
                            dims_of_img=(1,streamwise_length,400), num_of_steps=100, grad_cost_func=grad_cost_func_generalized, meas_func_list=[meas_func_1],
            ...
            sample = infer_grad_generalized(fm = FlowMatcher(1e-3), cfm_model=model,
                            total_samples=total_samples, samples_per_batch=samples_per_batch,
                            dims_of_img=(1,streamwise_length,400), num_of_steps=100, grad_cost_func=grad_cost_func_generalized, meas_func_list=[meas_func_1, meas_func_2],
