...
state = torch.load(f"/home/meet/FlowMatchingTests/conditional-flow-matching/physics_flow_matching/patched_flow_matching/exps/wp/exps_patch_no_inner_scaling/exp_{exp}/saved_state/checkpoint_{iteration}.pth")
...
np.save(f"/home/meet/FlowMatchingTests/conditional-flow-matching/physics_flow_matching/patched_flow_matching/exps/wp/exps_patch_no_inner_scaling/exp_{exp}/samples_cond_autoreg_{iteration}_s{int(mask.sum())}_re500.npy", samples*std + m)